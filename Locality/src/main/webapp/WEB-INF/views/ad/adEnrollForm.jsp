		  ...
		  <div class="col-lg-10">
			<div class="panel-body">
				...
				<div class="content-outer"> ★ 우리가게를 홍보해주세요 ★
					<form action="adInsert" class="write" method="post" enctype="multipart/form-data">
						<table>
							<tbody>
								<tr>
									<th>제목</th>
									<td>
										<input type="text" name="adTitle" id="title" required>
									</td>
								</tr>
								<tr>
									<th>작성자</th>
									<td>
										<input type="text" name="commuWriter" value="" readonly>
								...
								<tr id="text-area">
									<td colspan="2">
										<img src="" id="img_1">
										<textarea name="adContent" required></textarea>
									</td>
								</tr>
							</tbody>
						</table>
