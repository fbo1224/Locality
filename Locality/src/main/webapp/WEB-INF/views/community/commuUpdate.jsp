		  ...
		  <div class="col-lg-10">
			<div class="panel-body">
				...
				<div class="content-outer"> ★ 나혼자만 알기엔 아까운 것들을 공유해주세요 ★
					<form action="update.commu" class="write" method="post" enctype="multipart/form-data">
						...
						<table>
							<tbody>
								<tr>
									<th>제목</th>
									<td>
										<input type="text" name="commuTitle" required value="${ commuBoardVO.commuTitle }">
									</td>
								</tr>
								<tr>
									<th>작성자</th>
								...
								<tr>
									<th>카테고리</th>
									<td>
										<select name="categoryNo" id="select_category" required value=${ commuBoardVO.categoryNo }>
								...
								<tr>
									...
									<td>
										...
										<c:if test="${ not empty commuBoardVO.originName }">
											현재 업로드된 파일 :
			                           		 <a href="${ commuBoardVO.changeName }" download="${ commuBoardVO.originName }">${ commuBoardVO.originName }</a>
			                           		 <input type="hidden" value="${ commuBoardVO.originName }" name="originName"/>
			                           		 <input type="hidden" value="${ commuBoardVO.changeName }" name="changeName"/>											
										</c:if>
									</td>
								</tr>
								<tr id="text-area">
									<td colspan="2">
										<img src="${ commuBoardVO.changeName }" id="img_1">
										<textarea name="commuContent" required>${ commuBoardVO.commuContent }</textarea>
									</td>
								</tr>
							</tbody>
						</table>
